...
describe('VideoPlayer interactions', () => {
  ...
  it('configures thumbnail preview size, fit, and seekbar gap from props', async () => {
    ...
    slider.getBoundingClientRect = () =>
      ({ left: 0, width: 200, right: 200, top: 0, bottom: 10, height: 10, x: 0, y: 0, toJSON: () => ({}) }) as DOMRect
    ...
    expect(container.querySelector('.vplayer__seek-preview-time')).toHaveTextContent('0:50')
  })
